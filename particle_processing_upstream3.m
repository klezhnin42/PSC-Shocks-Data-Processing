...
xshock = [160.0,160.0,160.0,160.0];
...
plot(en,maxvalspec*exp(-en/(TTe*1.8*11.3676568))+1.3e-2*maxvalspec*exp(-en/(TTe*30*11.3676568)),'r--','LineWidth',3)
hold on
...
ylim([1 2e7]);
   %set(gca, 'XScale', 'log');
set(gca, 'YScale', 'log');
saveas(h,strcat(datadir,particle,'EnergySpectrumUpstream3Evol','.png'),'png');
delete(h);
